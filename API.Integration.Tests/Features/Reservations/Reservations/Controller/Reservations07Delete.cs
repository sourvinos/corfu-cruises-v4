...
namespace Reservations {
    ...
    public class Reservations07Delete : IClassFixture<AppSettingsFixture> {
        ...
        public async Task Simple_Users_Can_Not_Delete() {
            await Forbidden.Action(_httpClient, _baseUrl, _deleteUrl, _actionVerb, "simpleuser", "A#ba439de-446e-4eef-8c4b-833f1b3e18aa", null);
        }

        [Fact]
        public async Task Admins_Can_Delete() {
            await RecordDeleted.Action(_httpClient, _baseUrl, _deleteUrl, "john", "A#ba439de-446e-4eef-8c4b-833f1b3e18aa");
        }
