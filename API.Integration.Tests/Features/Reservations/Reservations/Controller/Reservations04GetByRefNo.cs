...
namespace Reservations {
    ...
    public class Reservations04GetByRefNo : IClassFixture<AppSettingsFixture> {
        ...
        public async Task Active_Users_Get_Empty_List_If_Not_Exists() {
            await RecordFound.Action(_httpClient, _baseUrl, _notFoundUrl, "john", "A#ba439de-446e-4eef-8c4b-833f1b3e18aa");
        }

        [Fact]
        public async Task Simple_Users_Get_Empty_List_If_Not_Owned() {
            await RecordFound.Action(_httpClient, _baseUrl, _simpleUserUrl_not_owned, "simpleuser", "A#ba439de-446e-4eef-8c4b-833f1b3e18aa");
        }

        [Fact]
        public async Task Simple_Users_Can_Get_By_RefNo_If_Owned() {
            await RecordFound.Action(_httpClient, _baseUrl, _simpleUserUrl_owned, "simpleuser", "A#ba439de-446e-4eef-8c4b-833f1b3e18aa");
        }

        [Fact]
        public async Task Admins_Can_Get_By_RefNo() {
            await RecordFound.Action(_httpClient, _baseUrl, _adminUrl, "john", "A#ba439de-446e-4eef-8c4b-833f1b3e18aa");
        }
