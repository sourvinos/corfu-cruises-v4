...
namespace Genders {
    ...
    [Collection("Sequence")]
    public class Genders02GetForBrowser : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/genders/getForBrowser";

        #endregion

        public Genders02GetForBrowser(AppSettingsFixture appsettings) {
