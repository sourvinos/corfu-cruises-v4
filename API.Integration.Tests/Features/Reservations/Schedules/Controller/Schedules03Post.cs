...
namespace Schedules {
    ...
    public class Schedules03Post : IClassFixture<AppSettingsFixture> {
        ...
        public async Task Admins_Can_Not_Create_When_Invalid(NewTestSchedule record) {
            var actionResponse = await RecordInvalidNotSaved.Action(_httpClient, _baseUrl, _url, _actionVerb, "john", "A#ba439de-446e-4eef-8c4b-833f1b3e18aa", record.TestScheduleBody);
        ...
        public async Task Admins_Can_Create_When_Valid(NewTestSchedule record) {
            await RecordSaved.Action(_httpClient, _baseUrl, _url, _actionVerb, "john", "A#ba439de-446e-4eef-8c4b-833f1b3e18aa", record.TestScheduleBody);
        }
