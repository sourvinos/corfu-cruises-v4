...
namespace API.Infrastructure.ReservationQueueServices {
    ...
    public class ReservationUpdateQueueService : BackgroundService {
        ...
        public ReservationUpdateQueueService(
            ...
            IReservationParametersRepository parametersRepo,
            IReservationProcessQueueRepository reservationProcessQueueRepo,
            IReservationUpdateQueueRepository linkTwistQueueRepo,
