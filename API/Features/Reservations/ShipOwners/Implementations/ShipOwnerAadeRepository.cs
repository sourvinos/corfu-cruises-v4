...
namespace API.Features.Reservations.ShipOwners {
    ...
    public class ShipOwnerAadeRepository : IShipOwnerAadeRepository {

        public ShipOwnerAadeRepository() { }

        public string GetResponse(ShipOwnerAadeVM vm) {
        ...
        private static XmlDocument ReplaceFieldsWithVariables(XmlDocument soapEnvelopeXml, ShipOwnerAadeVM vm) {
